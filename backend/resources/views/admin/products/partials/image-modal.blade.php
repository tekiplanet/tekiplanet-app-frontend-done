<div id="imageModal" class="fixed inset-0 z-50 overflow-y-auto hidden">
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full dark:bg-gray-800">
            <form id="imageForm" onsubmit="handleImageSubmit(event)" class="p-6">
                ...
                <div class="mt-5 sm:mt-6 flex justify-end gap-2">
                    ...
                    <button type="submit" 
                        ...
                        <span id="imageSubmitButtonText">Add Image</span>
...
async function handleImageSubmit(e) {
    ...
    imageSubmitButtonText.textContent = 'Adding...';
    
    const formData = new FormData(imageForm);
    formData.append('is_primary', document.getElementById('is_primary').checked);
    
    try {
        const response = await fetch('{{ route('admin.products.images.store', $product) }}', {
            method: 'POST',
            headers: {
