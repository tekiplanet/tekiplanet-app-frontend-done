            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admin.workstation.plans.update', $plan) }}" method="POST" 
                        x-data="planForm({{ json_encode([
                            'name' => $plan->name,
                            'price' => $plan->price,
                            'duration_days' => $plan->duration_days,
                            'print_pages_limit' => $plan->print_pages_limit,
                            'meeting_room_hours' => $plan->meeting_room_hours,
                            'has_locker' => $plan->has_locker,
                            'has_dedicated_support' => $plan->has_dedicated_support,
                            'allows_installments' => $plan->allows_installments,
                        ...
                        <div class="mt-6 flex justify-end">
                            <button type="submit" 
                                ...
                                <span x-text="loading ? 'Updating...' : 'Update Plan'"></span>
                            </button>
                        </div>
                    </form>
                </div>
