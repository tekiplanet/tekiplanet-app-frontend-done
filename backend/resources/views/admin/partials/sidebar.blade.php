                    ...
                    <li>
                        <div x-data="{ open: {{ request()->routeIs('admin.hustles.*') ? 'true' : 'false' }} }">
                            ...
                            <div x-show="open" class="mt-1 space-y-1" style="display: none;">
                                ...
                                @if(request()->routeIs('admin.hustles.show'))
                                    <a href="{{ route('admin.hustles.applications.index', request()->route('hustle')) }}" 
                                       class="{{ request()->routeIs('admin.hustles.applications.*') ? 'bg-gray-700' : '' }} text-gray-400 hover:text-white hover:bg-gray-700 group flex gap-x-3 rounded-md p-2 pl-11 text-sm leading-6 font-semibold">
                                        Applications
                                    </a>
                                @endif
                            </div>
